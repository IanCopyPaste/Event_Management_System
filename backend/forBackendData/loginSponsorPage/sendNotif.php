...
$mail->Body = "Dear " . $data["company_name"] . ",

Greetings!

Thank you for submitting your application for " . $data["company_name"] . "
...
echo json_encode([
    "status" => true,
    "message" => "Application Successfuly Sent! Check Email for Confirmation!"
]);
