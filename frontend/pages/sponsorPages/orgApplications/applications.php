...
<script>
    ...
    async function loadSponsors() {
        const res = await fetch("backend/forBackendData/sponsor_pages/applications/getAdvertisements.php", {
            method: "POST",
            headers: {
    ...
    async function fetchSpecificSponsor(id) {
        ...
        txtApplication_status.value = r.application_status.toUpperCase();
    ...
    async function updateStatus(status) {
        ...
        const response = await fetch("backend/forBackendData/sponsor_pages/applications/updateStatus.php", {
            method: "POST",
            headers: {
                "Content-Type": "application/json"
            },
